...
<title>Продажа адены Lineage</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="Покупка/продажа адены на серверах Lineage.">
...
<link rel="shortcut icon" href="/img/favicon_lineage.ico">
...
<body>
	<div class="global_background_lineage"></div>
	<div class="container">
		<div class="row clearfix">
			...
			<ul class="nav nav-tabs">
					<li class="<%=getServletConfig().getInitParameter("index")%>"><a href="/lineage/home/">Главная</a></li>
					<li class="<%=getServletConfig().getInitParameter("howto")%>"><a href="/lineage/how-to">Поставщикам</a></li>
					<li class="<%=getServletConfig().getInitParameter("powerleveling")%>"><a href="/l/powerleveling/">Реквизиты</a></li>
					<li class="<%=getServletConfig().getInitParameter("payment")%>"><a href="/lineage/payment/">Услуги</a></li>
